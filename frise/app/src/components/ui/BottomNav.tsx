...
// Premium SVG Icons with refined strokes
      ...
      <nav className="fixed bottom-4 left-4 right-4 md:hidden z-50">
        <motion.div
          className="
            ...
            rounded-[28px]
            shadow-[0_8px_32px_-8px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.05)_inset]
                    ...
                    <AnimatePresence>
                      {isActive && (
                        <motion.div
                          ...
                          className="absolute inset-0 bg-[var(--accent-blue)]/10 rounded-xl -z-10"
